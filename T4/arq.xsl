...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                        ...
                        <td width="30%" valign="top">
                            ...
                            <ol>
                                <xsl:apply-templates select="//ARQELEM" mode="indice">
                                    <xsl:sort select="IDENTI" data-type="number" order="descending"/>
                                </xsl:apply-templates>
                            </ol>
                        </td>
                        <td>
    ...
    <xsl:template match="ARQELEM" mode="indice">
        <li>
            <a name="i{count(preceding-sibling::*)+1}"/>
        ...
        <xsl:result-document href="site/arq{count(preceding-sibling::*)+1}.html">
            <html>
                ...
                <body>
                    <xsl:apply-templates/>
                    <address>
            [           <a href="index.html#i{count(preceding-sibling::*)+1}">Voltar ao Índice</a>]
                    </address>
                </body>
            </html>
        </xsl:result-document>
